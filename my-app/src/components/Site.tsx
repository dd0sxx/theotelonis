...
function Site () {
    ...
    return (
        ...
        <article className='about-article'>
            <h1 className='article-title'>About This Site</h1>
            <div className='about-content'>
                <aside>
                    <ol className='toc'>
                        <a href='#why'><li className='toc-lvl1'><span className='toc-num-1'>1 </span>Why?</li></a>
                            <a href='#motivations'><li className='toc-lvl2'><span className='toc-num-2'>1.1 </span>Motivations</li></a>
                ...
                <h2 className='about-header' id='why'>Why?</h2>
                    <p>The answer to the holy 'why' question will undoubtebly evolve over time. The reasons for which I have created this site now will surely be different than my reasons for maintaining it and updating it in the future. This site is a living document, and as such I can only attest to my reasonsings during the creation and early development phases which I am currently in.</p>
                    <h3 id='motivations' className='about-sub-header'>Motivations</h3>
                    <p>Clearly, this site serves as a sort of portfolio and resume for me. I have attempted to create an online portal for my work before, however my implementation was naive. It is important to me that there is a central hub for which I can upload personal projects and musings, so this is serving as a more mature effort to create such a portal. <br/>
                    <span style={{'padding': '40px'}}/> Personally, the most important motivation for me is to create a space which encourages the type of work I would like to be producing. In creating such a space, it is my hope that I will fill it with work that is personally satisfactory. The main elements missing from any of my past works which I would like to incorporate into those moving forward
                    </p>
